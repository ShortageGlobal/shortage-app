/*
  ...
  - Added the required column `shortageProductImage` to the `ShortageProductPair` table without a default value. This is not possible if the table is not empty.
  - Added the required column `shortageProductName` to the `ShortageProductPair` table without a default value. This is not possible if the table is not empty.
