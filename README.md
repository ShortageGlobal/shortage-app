...
by the new one, which you can obtain from `shopify.app.local.toml`, `application_url` value.

```js
// extensions/donate-button/blocks/donate_button.liquid
...
3. Place the "Donate Button" block under the "Add to cart" button on the product page.
4. Save.
